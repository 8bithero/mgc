        ...
        <section id="content">
          <section class="vbox bg-white">
            <header class="header b-b b-light">
              <p>Stock footage - <?php echo $userdata->first_name;?> <?php echo $userdata->last_name;?></p>
            </header>
            <section class="scrollable">
              <div id="gallery" class="gallery hide">
                ...
                <div class="item">
                  ...
                  <a href="<?php bloginfo('url')?>/backboard/?page=edit_stock&id=<?php the_ID();?>"></a>                  
                  <div class="desc">
                      <h4><?php the_title();?></h4>
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/backboard/js/pe.mopho/jquery.pixelentity.mopho.min.js"></script>
  	<script>
		jQuery(function($){
			$(".peMopho").peMopho();
		});
